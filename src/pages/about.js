...
function Hello() {
    return ( <
        ...
        <
        Text > < span style = {
            { color: "#25c2a0", fontWeight: 800 } } > gin - vue - admin < /span>采用Apache Licene 2.0 协议，闭源项目不受影响，开源项目需保留原协议。无需商业授权即可商用。</Text >
        <
        /Row> <
        Row gutter = { 16 } >
        <
        ...
        Popover content = { < Image
            ...
            Text style = {
                { color: "#25c2a0", fontWeight: 800, cursor: "pointer" } } > 点我获取微信加群二维码 < BarcodeOutlined / > < /Text> <
            /Popover> <
            /Row> <
            ...
            <
            Text > < span style = {
                { color: "#25c2a0", fontWeight: 800 } } > Mr.奇淼 < /span>,本名蒋吉兆，目前工作于北京某创业公司。</Text >
            <
            /Row> <
            Row gutter = { 16 } >
            <
            Text > 个人本职为公司前端技术负责人， 业余时间会做一些开源的小东西， < span style = {
                { color: "#25c2a0", fontWeight: 800 } } > gin - vue - admin < /span>就是疫情期间的无心插柳。 </Text >
            <
            /Row> <
            Row gutter = { 16 } >
            <
            ...
            justify = "start"
            style = {
                { background: "#f2f2f2", marginTop: "10px", borderRadius: "10px", paddingLeft: "10px" } } >
            <
            div style = {
                { display: "inline-block", paddingTop: "20px" } } >
            <
            Image
            width = { 140 }
            ...
            /div> <
            div style = {
                { display: "inline-block", padding: "20px", width: "calc(100% - 140px)" } } >
            <
            div >
            <
            ...
            Text > 个人介绍: 热爱编程,
            对代码有洁癖,
            好的代码就是気持ちいい。 任何时候， 绝不骄傲， 绝不轻敌， 摸清对方心里， 使劲浑身解数， 保持笑容和品行， 无论发生什么， 千万不要忘记扑克脸。 < /Text> <
            /div> <
            div style = {
                { paddingTop: "5px" } } >
            <
            Text > 主要职责: 负责gin - vue - admin的新功能研发测试与改进,
            gf - vue - admin的后端开发及维护,
            社区日常维护管理等工作。 < /Text> <
            /div> <
            div style = {
                { paddingTop: "5px" } } >
            ...
            <
            Text > < span style = {
                { color: "#25c2a0", fontWeight: 800 } } > gin - vue - admin单体版 < /span>将会秉持开源精神，免费到底，一群活跃的小伙伴也会不断进行日常维护，目前项目可以稳定进入生产环境，日后还会根据用户需求增加更多的便于开发的基础功能,将Gin-Vue-Admin做得更加完善，更加强大，非常期待有更多的小伙伴们加入我们Gin-Vue-Admin的团队。</Text >
            <
            /Row> <
            Row gutter = { 16 }
            style = {
            ...
            style = {
                { marginTop: "10px" } } >
            <
            Text > 团队所有成员均可在 < span style = {
                { color: "#25c2a0", fontWeight: 800 } } > Gin - Vue - Admin官网 < /span>增加个人简介并且附带<span style={{ color: "#25c2a0", fontWeight: 800 }}>专属技能</span > < /Text> <
            /Row> <
            Row gutter = { 16 }
            style = {
                { marginTop: "30px" } } >
            ...
            <
            Text > 目前 < span style = {
                { color: "#25c2a0", fontWeight: 800 } } > Gin - Vue - Admin < /span>Github已经拥有<span style={{ color: "#25c2a0", fontWeight: 800 }}>9K+</span > 的star， 项目官网以及github页面每天都有大量的访问量， 您可以成为Gin - Vue - Admin的赞助商， 我们会在适当的位置， 悬挂您的推广内容 < /Text> <
            /Row> <
            Row gutter = { 16 }
            style = {
                { marginTop: "10px" } } >
            <
            Text > 赞助请加微信： < span style = {
                { color: "#25c2a0", fontWeight: 800 } } > shouzi_1994 < /span>标明<span style={{ color: "#25c2a0", fontWeight: 800 }}>广告赞助</span > < /Text> <
            /Row> <
            /div> <
            /Layout>
        );
